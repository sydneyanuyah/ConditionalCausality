...
CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES:-0} nohup python3 train_phi_exp3.py \
  ...
  --output_dir outputs_exp3_2_qwen_probe_ft_synthetic \
  ...
  > logs/exp3_2_qwen_probe_ft_synthetic.log 2>&1 &

echo "Started Qwen Exp3.2 Synthetic training."
echo "Log: tail -f logs/exp3_2_qwen_probe_ft_synthetic.log"
